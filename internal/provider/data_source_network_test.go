		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.cidr_network.test", "hostnum", "1"),
				),
			},
		},
	})
...
func TestAccDataSourceNetwork_IPv4Prefix(t *testing.T) {
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccDataSourceNetworkPrefix("192.168.1.42/22"),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("data.cidr_network.test", "prefix", "192.168.1.42/22"),
					resource.TestCheckResourceAttr("data.cidr_network.test", "network", "192.168.0.0/22"),
					resource.TestCheckResourceAttr("data.cidr_network.test", "ip", "192.168.1.42"),
					resource.TestCheckResourceAttr("data.cidr_network.test", "mask", "255.255.252.0"),
					resource.TestCheckResourceAttr("data.cidr_network.test", "mask_bits", "22"),
					resource.TestCheckResourceAttr("data.cidr_network.test", "first_ip", "192.168.0.1"),
					resource.TestCheckResourceAttr("data.cidr_network.test", "last_ip", "192.168.3.254"),
					resource.TestCheckResourceAttr("data.cidr_network.test", "broadcast", "192.168.3.255"),
					resource.TestCheckResourceAttr("data.cidr_network.test", "hostnum", "298"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.cidr_network.test", "hostnum", "0"),
				),
			},
		},
	})
...
func TestAccDataSourceNetwork_IPv6Prefix(t *testing.T) {
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccDataSourceNetworkPrefix("fe80::3:0:0:42/81"),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("data.cidr_network.test", "prefix", "fe80::3:0:0:42/81"),
					resource.TestCheckResourceAttr("data.cidr_network.test", "ip", "fe80::3:0:0:42"),
					...
					resource.TestCheckResourceAttr("data.cidr_network.test", "hostnum", "66"),
				),
			},
		},
	})
